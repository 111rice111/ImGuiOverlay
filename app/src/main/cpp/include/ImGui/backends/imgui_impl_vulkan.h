...
struct ImGui_ImplVulkan_InitInfo {
  ...
  // even for Vulkan 1.3 + setup PipelineRenderingCreateInfo.
...
IMGUI_IMPL_API void ImGui_ImplVulkan_CreateMainPipeline(
    const ImGui_ImplVulkan_MainPipelineCreateInfo
        &info); // (render_pass xor (p_dynamic_rendering && p_dynamic_rendering
                // is correct (sType and pNext)))
