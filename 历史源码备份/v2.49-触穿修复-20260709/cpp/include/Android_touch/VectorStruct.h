...
struct My_Vector2 {
  ...
  inline My_Vector2 operator-() const { return My_Vector2(-x, -y); }
  ...
  inline bool NotHaveZero() { return x != 0 && y != 0; }
...
struct My_Vector3 {
  ...
  inline My_Vector3 operator-() const { return My_Vector3(-x, -y, -z); }
  ...
  static inline bool inRange(const My_Vector3 &target, const My_Vector3 &min,
                             const My_Vector3 &max) {
    return target.x > min.x && target.x < max.x && target.y > min.y &&
           target.y < max.y && target.z > min.z && target.z < max.z;
  }
};
struct My_Vector4 {
  float x;
  ...
  inline My_Vector4(float x, float y, float z, float w)
      : x(x), y(y), z(z), w(w) {}
  inline explicit My_Vector4(float value)
  ...
  inline My_Vector4 operator-() const { return My_Vector4(-x, -y, -z, -w); }
  ...
  inline bool NotHaveZero() { return x != 0 && y != 0 && z != 0 && w != 0; }
...
inline bool isInRange(const My_Vector2 &target, const My_Vector2 &min,
                      const My_Vector2 &max) {
  return target.x > min.x && target.x < max.x && target.y > min.y &&
         target.y < max.y;
}
inline bool isInRange(const My_Vector3 &target, const My_Vector3 &min,
                      const My_Vector3 &max) {
  return target.x > min.x && target.x < max.x && target.y > min.y &&
         target.y < max.y && target.z > min.z && target.z < max.z;
}
