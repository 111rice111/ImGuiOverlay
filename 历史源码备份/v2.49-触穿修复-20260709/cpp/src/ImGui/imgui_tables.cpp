...
void ImGui::TableSetColumnWidth(int column_n, float width) {
  ...
  // column, we support more cases here. When forwarding resize from Wn| to
  // Fn+1| we need to be considerate of the _NoResize flag on Fn+1.
  ...
  // hard to fix. [Resize Rule 1] Can't resize from right of right-most visible
  // column if there is any Stretch column. Implemented in TableUpdateLayout().
